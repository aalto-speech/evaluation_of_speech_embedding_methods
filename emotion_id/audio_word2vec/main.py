...
checkpoint = torch.load("weights/feature_extractor/state_dict_59.pt", map_location=torch.device("cpu"))
...
if skip_training == False:
    ...
    checkpoint = torch.load("weights/emo_id_model/state_dict_4.pt", map_location=torch.device("cpu"))
    classifier.load_state_dict(checkpoint["classifier"])
    classifier.eval()
