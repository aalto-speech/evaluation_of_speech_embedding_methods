...
if skip_training == False:
    ...
    #checkpoint = torch.load("weights/temp/state_dict_14.pt")
    ...
    checkpoint = torch.load("weights/emo_id_model/state_dict_15.pt", map_location=torch.device("cpu"))
    classifier.load_state_dict(checkpoint["classifier"])
    classifier.eval()
