...
def train(pairs_batch_train, pairs_batch_dev, classifier, classifier_optimizer, criterion, batch_size, num_epochs, device):
    ...
    for epoch in range(100):
        if early_stopping == False:
            ...
            if f1 >= prev_best:
                ...
                }, "weights/gender_model/state_dict_" + str(epoch+1) + ".pt")
